...
public class S2CHandler {
    ...
    private static void openChooseTownScreen(OpenChooseTownScreenS2CPacket packet, Player player, PacketSender sender) {
        Minecraft.getInstance().setScreen(new ChooseTownScreen(Component.translatable("gui.botwmcs.realmshost.chooseTownScreen.title"), player, packet.showBackground()));
    }
}
